 ...
 * 
 */
public class TwoSearchActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_rent);
		initData();
		initView();
	}
	...
	private void initView() {
		...
		if(mSp == null){
			mSp = this.getSharedPreferences("historyTwo", MODE_PRIVATE);
		}
		if(mList == null){
	...
	protected void returnData(String mKeyWord) {
		Intent intent = new Intent();
		intent.putExtra("params",mKeyWord);
		TwoSearchActivity.this.setResult(RESULT_CODE, intent);
	}
